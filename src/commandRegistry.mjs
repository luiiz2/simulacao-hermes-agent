...
export const DEFS = [
  ...
  { name: "compress", aliases: ["compact"], cat: "SESSÃO", perm: "user", requiresAI: false, desc: "Comprime contexto da conversa" },
  ...
  { name: "diff", aliases: ["diffs"], cat: "PROJETO", perm: "user", requiresAI: false, desc: "Mostra alterações de código da sessão" },
